			...
			<table width="750" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    <td>
			      ...
			      <table width="750" border="0" cellspacing="0" cellpadding="0">
			     		<tr align="center">
						    <td height="38"><b>교육시간표 - ${searchType}</b></td>
						  </tr>
						  <tr align="right">
			          ...
			          <td>
			            <table width="750" border="1" cellspacing="0" cellpadding="0">
			             	<c:forEach var="timeTblCrsList" items="${rsCrs_TimeTblCrsList}" varStatus="i">
			           			<tr align="center">
			           				<td>${i.count}</td>
			                  <td>${timeTblCrsList.coursename}<br>${timeTblCrsList.stdcnt }명/${timeTblCrsList.lecroom}<br>${fn:substring(timeTblCrsList.lectdate, 4, 6)}월 ${fn:substring(timeTblCrsList.lectdate, 6, 8)}일</td> 
