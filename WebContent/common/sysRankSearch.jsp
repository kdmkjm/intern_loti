...
function getRankName(rCode, rName)
{
	opener.document.forms[0].rankcode.value=rCode;
	opener.document.forms[0].rankname.value=rName;
          ...
          <td bgcolor="#FFFFFF" valign="top"> 
          		...
          		<tr>
          			<td>
			            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			              <tr> 
			                <td background='<html:rewrite page="/images/board/popup_title_bg.gif"/>' height="42"><img src='<html:rewrite page="/images/resources/title_03-5.gif"/>' alt="직급목록"/></td>
			              </tr>
			              <tr> 
			                <td height="10"></td>
			              </tr>
			              <tr valign="top" align="center"> 
			                <td>
												<!--검색 테이블 시작-->
												<html:form method="POST" action="/cmnRankJob.act?task=poprank&flag=search">
												<table width="360" border="0" height="35" cellspacing="0" cellpadding="0">
													<tr>
														<td width="85" class="pItem">직급명칭</td>
												...
												<table width="360" border="0" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8">
												  <tr>
												    <td class="pt1" width="100">직급코드</td>
												    <td class="pt1">직급명칭</td>												    
												  </tr>
												</table>
												<!--검색 헤더 끝-->    
												<!--검색 리스트 시작-->
											  ...
											  <table id="mainTable" width="343" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8">
												<c:set var="no" scope="request" value="1"/>
													<c:forEach var="list" items="${sysRankList}" varStatus="i">
														<!-- 열 배경 -->
														...
														<tr class="${lineBg}">
															<td class="pt2" width="100" >
												  			<a href="#" onclick="getRankName('${list.rankcode}','${list.rankname}');"><u><c:out value="${list.rankcode}"/></u></a>
											  			</td>
															<td class="pt2"><c:out value="${list.rankname}"/></td>															
														</tr>
