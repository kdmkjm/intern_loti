          ...
          <td bgcolor="#FFFFFF" valign="top"> 
          		...
          		<tr>
          			<td>
			            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			              <tr> 
			                <td background='<html:rewrite page="/images/board/popup_title_bg.gif"/>' height="42"><img src='<html:rewrite page="/images/operation/title_28.gif"/>' alt="교육과정 송신 결과 - 세부"/></td>
			              </tr>
			              <tr> 
			                <td height="10"></td>
			              </tr>
			                ...
			                <td>
												<table width="660" border="0" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8">
												  <tr> 
												    ...
												    <td class="pt1" width="35">교육<br>정원</td>
												    <td class="pt1" width="45" title="숙박구분 - 비합숙:0  합숙:1">숙박<br>구분</td>
												    <td class="pt1" width="70">교육대상</td>
												    <td class="pt1" width="72" title="확정상태 - 집합:1, 사이버:2, 집합+사이버:3, 기타:4">학습방법</td>
												  </tr>
												</table>
												<!--검색된 과정 리스트 시작-->
												...
												<c:forEach var="list" items="${rsOpr_TransResultFileInfo}" varStatus="i" >
												    ...
												    <td class="pt2" width="45" title="숙박구분 - 비합숙:0  합숙:1">${list.stayFlag}</td>
												    <td class="pt2" width="70">${list.eduTarget}</td>
												    <td class="pt2" width="55" title="확정상태 - 집합:1, 사이버:2, 집합+사이버:3, 기타:4">${list.eduMethod}</td>
													</tr>
