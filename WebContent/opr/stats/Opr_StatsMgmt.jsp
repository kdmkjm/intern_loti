...
<!--
	function stats()
	{
		...
		frm.action = "oprStats.act?task=stats";
		frm.submit();
	}
	function ExcelDownload()
	{
		size_w = 100;
  		...
  		url += '?task=excel'
  		url += '&searchCourseCode=' + document.forms[0].searchCourseCode.value;
  		url += '"/>';
  		target = '_blank';
...
<tr>
  <td>
    <!--검색 -->
	<html:form method="POST" action="oprStats.act?task=crsName">
	  <table width="750" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #D6D6D6">
	  <tr>
		<td width="99" class="s1">교육기간</td>
		<td class="sBar"></td>
		<td class="s2" width="120">
		  <html:text property="searchKeyword" readonly="true" style="width:70px; IME-MODE:disabled" maxlength="10" onkeydown="key_num_minus()"/><img src='<html:rewrite page="/images/icon/calendaricon.gif"/>' align="absbottom" style="cursor:hand" onclick="Calendar_M(document.forms[0].searchKeyword);">
		</td>
		<td width="70">
		...
		<td class="sBar"></td>
		<td width="99" class="s1">과정선택</td>
		<td class="sBar"></td>
		<td class="s2">
		  <html:select property="searchCourseCode" style="width:320px;" onchange="stats();">
			<html:option value="">선택</html:option>
		    <html:optionsCollection name="selCrsName" property="beanCollection" />
		  </html:select>
		</td>
	  </tr>
	  </table>
