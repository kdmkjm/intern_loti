             ...
             <table width="750" border="0" cellspacing="1" cellpadding="0" bgcolor="#E6E6E6">
              ...
              <tr>
                <td>
                  ...
                  <c:if test="${count>0}">
					<img src='<html:rewrite page="/images/board/btn_save.gif"/>' width="57" height="25" alt="저장" align="absmiddle" onclick="finsert();" style="CURSOR: hand" />
                </c:if>
                </td>
              </tr>
              <tr>
