...
$.noConflict();
	...
	function checkDelete(){
		if(jQuery('#mainTable input[name="board_Idx_array"]:checked').size() == 0){
			...
			if(confirm('삭제하시겠습니까?')){
				var $form = jQuery('<form action="/extCrs_ReqCrs.act?task=delete" method="post"/>').appendTo('body');
...
<tr>
  <td>
	...
	<h1><img alt="과정요청" src="/images/community/title_05.gif" /></h1>
	</div>
  </td>
</tr>
<tr>
  <td>
	<!--검색 -->
	<form method="POST"  action='<html:rewrite page="/extCrs_ReqCrs.act?task=list"/>'>
	  ...
	  <tr align="right" valign="top">
		...
		<td width="130" class="s2">
		  <input type="text" name="searchKeyword" title="제목" class="inputText" value="${searchKeyword}" />
		</td>
		<td width="60">
	...
	<tr>
	  <td>
		...
		<div id="mainList" style="width:746px; z-index:0;"> 
		  ...
		  <c:forEach var="list" items="${rsExtCrs_ReqCrsList}" varStatus="i" >
			<!-- 열 배경 -->
	...
	<table width="746" border="0" cellspacing="0" cellpadding="0" height="20">
