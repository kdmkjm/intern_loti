...
function temp_aa(treeNodes) {
	...
	document.listForm.conectMethod.value = nodeValues[2];
	//fnSearch();
	searchAction();
}
...
function updateMenuList() {
	alert("수정");
	document.menuListForm.action = "<c:url value='/sym/mpm/EgovMenuListUpdate.cb'/>";
	parent.cbcument.menuListForm.submit();
}
