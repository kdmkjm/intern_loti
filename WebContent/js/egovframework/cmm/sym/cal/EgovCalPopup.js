...
function fn_egov_AdministCalendar(frm, sDate, vDate) {
	...
	var url = "/sym/cmm/EgovAdministCalPopup.cb";
...
function fn_egov_NormalCalendar(frm, sDate, vDate) {
	...
	//var url = frm.cal_url.value;
	//var url = "/sym/cmm/EgovNormalCalPopup.cb";
	 var url = "/sym/cmm/EgovselectNormalCalendar.cb";
	...
	if( sAppName.indexOf("Netscape") > -1){
		openParam = "dialogWidth:275px;dialogHeight:152px;scroll:no;status:no;center:yes;resizable:yes;";
...
function fn_egov_Calendar(frm, sDate, vDate) {
	...
	//var url = frm.cal_url.value;
	var url = "/sym/cmm/callCalPopup.cb";
