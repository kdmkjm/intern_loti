	...
	<tr>
		...
		<td>
			...
			<span id="menu3outline" style="display:none;" class="t2"> 
				...
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/prf/prf05.jsp" 	target="iframe_Main"> <b>강사료 지급기준 </b></a><br> 
	...
	<tr>
		...
		<td>
			...
			<span id="menu4outline" style="display:none;" class="t2"> 
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/cost/cost01.jsp"		target="iframe_Main"> <b>검색-과정조회 (팝업)</b></a><br> 
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/cost/cost02.jsp" 	target="iframe_Main"> <b>교육비지출 </b></a><br> 
				...
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/cost/cost03.jsp" 	target="iframe_Main"> <b>교육비등록 (사이버민간)</b></a><br> 
				...
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/cost/cost04.jsp" 	target="iframe_Main"> <b>과정별 교육비</b></a><br> 
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<a href="${pageContext.request.contextPath}/help/cost/cost05.jsp" 	target="iframe_Main"> <b>교육비예산등록</b></a><br> 
				<img src='<html:rewrite page="/images/tree/joinbottom.gif"/>' align="absmiddle"/>		<a href="${pageContext.request.contextPath}/help/cost/cost06.jsp" 	target="iframe_Main"> <b>교육비분할</b></a><br> 
			<br>
			</span>
		</td>
	</tr>
