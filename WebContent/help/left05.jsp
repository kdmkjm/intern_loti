	...
	<tr>
		...
		<td>
			...
			<span id="menu6outline" style="display:none;" class="t2"> 
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<b>교육장관리</b><br> 
				...
				<img src='<html:rewrite page="/images/tree/join.gif"/>' align="absmiddle"/>					<b>교육장대여신청</b><br> 
