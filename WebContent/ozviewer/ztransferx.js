if(navigator.appName == "Microsoft Internet Explorer") {
  ...
  var ZTransferXObject = document.createElement('<object width = "0" height = "0" ID="ZTransferX" classid="CLSID:C7C7225A-9476-47AC-B0B0-FF3B79D55E67" codebase="http://127.0.0.1:8080/CustomNameSpace/ZTransferX_2,2,1,0.cab#version=2,2,1,0"></object>');
  ...
  InstallOZViewer.appendChild(ZTransferXObject);
    ...
    if(navigator.appVersion.charAt(0) == "5"){
      if(navigator.userAgent.indexOf("Firefox/3")!=-1){
        ...
        ZTransferXObject.setAttribute("type","application/ZtransferXPlugin;version=1,0,5,0");
        ZTransferXObject.setAttribute("codebase","http://127.0.0.1:8080/CustomNameSpace/OZViewer_1,0,5,0.xpi");
